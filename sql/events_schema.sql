...
-- Run this migration inside Supabase SQL to provision the data structures
-- that the Express application expects for storing brackets and per-player
-- win/loss records.
...
create index if not exists player_event_records_event_idx on public.player_event_records (event_id);
